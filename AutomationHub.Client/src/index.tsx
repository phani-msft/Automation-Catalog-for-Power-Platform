...
const Main = () => {
  ...
  const [isFeedbackDisplayed, setIsFeedbackDisplayed] = useState<boolean>(false);
      ...
      <TeamsFxContext.Provider value={{ theme, themeString, teamsUserCredential, context }}>
        <FluentProvider theme={theme}>
          <QueryClientProvider client={queryClient}>
            <AppContext.Provider value={{ appEnv, isFeedbackDisplayed, setIsFeedbackDisplayed }}>
  ...
  }, [teamsUserCredential, theme, themeString, context, queryClient, appEnv, isFeedbackDisplayed, deepLinkInfo, trackEvent, trackException, setCurrentPage]);
