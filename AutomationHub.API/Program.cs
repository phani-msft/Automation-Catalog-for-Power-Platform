...
using AutomationHub.API.Managers.Implementations;
using AutomationHub.API.Managers.Interfaces;
using AutomationHub.API.Providers.Implementations;
using AutomationHub.API.Providers.Interfaces;
using AutomationHub.API.Services.Implementations;
...
builder.Services.Configure<MembershipGroupsConfiguration>(builder.Configuration.GetSection(MembershipGroupsConfiguration.SectionName));
builder.Services.Configure<SemanticKernelConfiguration>(builder.Configuration.GetSection(SemanticKernelConfiguration.SectionName));
